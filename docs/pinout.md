...
- The LCD option `Configuration > MPU6050 / IMU > Devices / Wiring > Swap SDA/SCL` exchanges these two roles without reflashing.
- MPU6050 AD0 LOW = `0x68`; AD0 HIGH = `0x69`. Two modules may share PD8/PD9 when their AD0 straps differ.
- Firmware roles are persistent and independent: `Bed / Mesa`, `Toolhead / Extrusora`, or unused.
